...
const char JsonLdError::LoadingRemoteContextFailedError[] = "There was a problem encountered loading a remote context.";
const char JsonLdError::InvalidRemoteContextError[] = "No valid context document has been found for a referenced remote context.";
...
const char JsonLdError::InvalidVersionValueError[] = "The @version entry was used in a context with an out of range value.";
const char JsonLdError::ProcessingModeConflictError[] = "An attempt was made to change the processing mode which is incompatible with the previous specified version.";
...
const char JsonLdError::ContextOverflowError[] = "Maximum number of @context URLs exceeded.";
